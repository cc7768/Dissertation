...
\chapter{Acknowledgments}
  ...
  Thomas Sargent, and Stan Zin. They have each played a unique role in my development as an
  economist by helping my learn to direct my curiosity, teaching me the tools needed to do economic
  research, and providing encouragement when I didn't know what to do next. My life is greatly
  improved because of the time they were willing to share with me.
  ...
  Daniel Stackman, Balint Szoke, Venky Venkateswaran, Mike Waugh, Larry, White, Peifan Wu.
  ...
  This work is dedicated to my wife, Jessica Coleman, and my parents, Stephanie and Gregory Coleman.
...
\chapter{Student Loans}
  ...
  \input{sections/StudentLoans/intro}
  \input{sections/StudentLoans/background}
  \input{sections/StudentLoans/calibration}
  \input{sections/StudentLoans/results}
...
\chapter{Supplementary Material for Chapter 3} \label{sec:Appendix3}
  ...
  \input{sections/StudentLoans/appendix.tex}
  \input{sections/StudentLoans/tables_and_figs.tex}
